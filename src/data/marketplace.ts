...
export const marketplaceModules: MarketplaceModule[] = [
  ...
  },
  {
    ...
    category: "Assets",
    description: "Detect objects live, register enterprise assets, and identify their owners in operational zones.",
    features: ["Live webcam detection", "Asset registration", "Owner identification"],
    price: 399,
    billingCycle: "month",
    icon: Boxes,
  ...
  },
  {
    ...
    features: ["All five modules", "Bundle savings", "Priority model upgrades"],
    price: 2499,
    billingCycle: "month",
    icon: ShieldCheck,
    highlighted: true,
