...
export const detectionModules: DetectionModule[] = [
  ...
  },
  {
    ...
    features: ["Unlimited Real-Time Detection", "30-Day Historical Data Storage", "Custom Alerts & Webhooks"],
    workflow: ["Scene Capture", "Object Classification", "Event Timeline", "Webhook Dispatch"],
    price: "₹799/month",
